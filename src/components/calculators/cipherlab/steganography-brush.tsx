    ...
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-700">
        ...
        <CardHeader className="border-b border-[var(--dk-line)] flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 sm:p-8">
           ...
           <Tabs value={mode} onValueChange={(v) => setMode(v as 'encode' | 'decode')} className="w-full sm:w-[200px] shrink-0">
              <TabsList className="bg-[var(--dk-sunk)] border-[var(--dk-line)]">
                 <TabsTrigger value="encode" className="text-xs font-black uppercase text-[var(--dk-ink-soft)] border border-[var(--dk-line)] hover:bg-[var(--dk-raised)] hover:text-[var(--dk-ink)] data-[state=active]:bg-[#b388ff] data-[state=active]:text-[var(--dk-on-fill)] data-[state=active]:border-[#b388ff]">Obscure</TabsTrigger>
                 <TabsTrigger value="decode" className="text-xs font-black uppercase text-[var(--dk-ink-soft)] border border-[var(--dk-line)] hover:bg-[var(--dk-raised)] hover:text-[var(--dk-ink)] data-[state=active]:bg-[#b388ff] data-[state=active]:text-[var(--dk-on-fill)] data-[state=active]:border-[#b388ff]">Reveal</TabsTrigger>
              </TabsList>
           </Tabs>
        </CardHeader>
           ...
           <div className="grid lg:grid-cols-2 lg:min-h-[500px]">
              ...
              <div className="p-4 sm:p-8 lg:p-12 border-b lg:border-b-0 lg:border-r border-[var(--dk-line)] space-y-8 min-w-0">
                 <div className="space-y-4">
                    ...
                    <div className="relative group">
                       <Input
                         ...
                         className="bg-[var(--dk-sunk)] border-[var(--dk-line)] text-[var(--dk-ink)] h-14 rounded-2xl relative z-10 font-bold placeholder:text-[var(--dk-ink-soft)] focus:ring-[#b388ff]/50 focus:border-[#b388ff]"
                         value={message}
                 ...
                 <div className="pt-4 space-y-4">
                    <div className="text-[9px] font-black text-[var(--dk-ink-soft)] uppercase tracking-widest mb-2 border-l-2 border-[#b388ff] pl-3">Instruction</div>
                    ...
                    return (
                      <motion.div
                        ...
                        animate={{
                          ...
                          color: isRevealed ? '#b388ff' : 'var(--dk-ink-soft)'
                        }}
      ...
      <div className="grid md:grid-cols-3 gap-6">
         {[
           ...
           <Card key={idx} className="bg-[var(--dk-raised)] border-[var(--dk-line)] p-6 group hover:border-[#b388ff] transition-all">
