      ...
      <Card className="overflow-hidden relative" style={{ backgroundColor: 'var(--dk-surface)', borderColor: 'var(--dk-line)' }}>
        ...
        <CardContent className="grid lg:grid-cols-2 gap-8 relative z-10">
          ...
          <div className="flex flex-col items-center justify-center space-y-8 rounded-xl p-6" style={{ backgroundColor: 'var(--dk-sunk)', border: '1px solid var(--dk-line)' }}>
             ...
             <div className="w-full relative h-48 rounded-full overflow-hidden shadow-inner" style={{ backgroundColor: 'var(--dk-sunk)', border: '1px solid var(--dk-line)' }}>
                {/* Simulated Galaxy View */}
                <div className="absolute inset-0 opacity-50" style={{ backgroundColor: 'var(--dk-raised)' }}></div>
