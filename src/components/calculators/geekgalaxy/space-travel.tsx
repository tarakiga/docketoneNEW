      ...
      <Card className="shadow-2xl" style={{ backgroundColor: 'var(--dk-surface)', borderColor: 'var(--dk-line)' }}>
        ...
        <CardContent className="grid gap-8 lg:grid-cols-12 p-4 sm:p-6 lg:p-10">
          ...
          <div className="lg:col-span-4 space-y-6">
                ...
                {Object.entries(DEST_VALS).map(([key, data]) => (
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-[9px]" style={{ color: 'var(--dk-ink-soft)' }}>{(data.distKm).toExponential(1)} km</div>
                    </div>
                  </button>
                ))}
              </div>
              ...
              <div className="relative group/scroll">
                ...
                <div className="absolute bottom-0 left-0 right-2 h-12 pointer-events-none z-20 flex items-end justify-center pb-1">
                   <div className="flex flex-col items-center gap-1 animate-bounce opacity-40 group-hover/scroll:opacity-80 transition-opacity">
                      <span className="text-[7px] font-bold uppercase tracking-wider" style={{ color: 'var(--dk-ink-soft)' }}>Hangar Scroll</span>
                      <ChevronDown className="h-3 w-3" style={{ color: 'var(--dk-ink-soft)' }} />
                   </div>
                </div>
              </div>
            </div>
            ...
            {['rocket', 'starship', 'dragon', 'artemis'].includes(propulsion) && DEST_VALS[destination].au < 100 && (
              <div className="space-y-3 pt-2">
                ...
                <div className="p-4 rounded-xl border mt-2" style={{ backgroundColor: 'var(--dk-sunk)', borderColor: 'var(--dk-line)' }}>
                  <p className="text-[10px] font-medium leading-relaxed italic" style={{ color: 'var(--dk-ink-soft)' }}>
                    {useHohmann 
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            <div className="rounded-[1.5rem] sm:rounded-[2rem] p-4 sm:p-6 md:p-10 border flex flex-col justify-center gap-6 sm:gap-8 relative overflow-hidden group min-h-[280px] sm:min-h-[340px]" style={{ backgroundColor: 'var(--dk-sunk)', borderColor: 'var(--dk-line)' }}>
               <div className="absolute -right-24 -top-24 w-96 h-96 rounded-full opacity-20 animate-blob" style={{ backgroundColor: 'var(--dk-raised)' }} />
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 relative z-10">
                  <div className="min-w-0 p-5 rounded-2xl border" style={{ backgroundColor: 'var(--dk-surface)', borderColor: 'var(--dk-line)' }}>
                     <div className="flex items-center gap-2 mb-2" style={{ color: 'var(--dk-ink-soft)' }}>
            ...
            <div className="grid md:grid-cols-1 gap-6">
              {DEST_VALS[destination].au < 100 ? (
                <div className="space-y-4">
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    {stats.windows.map((win, idx) => (
                      <div key={idx} className="rounded-[1.5rem] p-4 sm:p-6 relative overflow-hidden group transition-all duration-700 border" style={{ backgroundColor: 'var(--dk-sunk)', borderColor: 'var(--dk-line)' }}>
                        <div className="flex flex-col gap-5 relative z-10">
                          <div className="space-y-1">
                            <div className="uppercase text-[9px] font-black tracking-widest" style={{ color: 'var(--dk-ink-soft)' }}>Epoch</div>
                            <div className="text-3xl font-black leading-none" style={{ color: 'var(--dk-ink)' }}>{win.year}</div>
                          </div>
                ...
                <Card className="shadow-2xl p-8 sm:p-12 md:p-20 text-center relative overflow-hidden rounded-[1.5rem] sm:rounded-[2.5rem]" style={{ backgroundColor: 'var(--dk-sunk)', borderColor: 'var(--dk-line)' }}>
              ...
              {[
                ...
                <Card key={i} className="transition-all group overflow-hidden relative rounded-2xl" style={{ backgroundColor: 'var(--dk-sunk)', borderColor: 'var(--dk-line)' }}>
                  ...
                  <CardContent className="relative z-10">
                    <p className="text-[10px] leading-relaxed font-bold italic" style={{ color: 'var(--dk-ink-soft)' }}>
                      {card.text}
                    </p>
                  </CardContent>
                </Card>
